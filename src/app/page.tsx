      ...
      <div className="container mx-auto px-4 py-16 sm:py-24">
        ...
        <div className="text-center space-y-6 mb-12">
          <div className="flex items-center justify-center mb-6">
            <div className="p-3 rounded-2xl bg-primary/10 animate-fadeIn">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground text-lg sm:text-xl animate-slideUp delay-300">
            Transform long, unwieldy links into clean, shareable URLs with just one click
          </p>
        </div>

        {/* URL Shortener Card */}
        <div className="max-w-2xl mx-auto animate-fadeIn delay-500">
          <URLShortener />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-20">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className={`p-6 rounded-xl border bg-card text-card-foreground hover:shadow-lg transition-all duration-300 animate-fadeIn delay-${index * 200}`}
            >
